...
-- Project :      DATA MODEL
--
-- Date Created : Saturday, September 28, 2019 22:57:39
...
CREATE TABLE ProspectiveBuyer(
    ProspectiveBuyerKey     INT                      AUTO_INCREMENT,
    ProspectAlternateKey    NATIONAL VARCHAR(15),
    FirstName               NATIONAL VARCHAR(50),
    MiddleName              NATIONAL VARCHAR(50),
    LastName                NATIONAL VARCHAR(50),
    BirthDate               DATETIME,
    ...
    TotalChildren           TINYINT,
    NumberChildrenAtHome    TINYINT,
    Education               NATIONAL VARCHAR(40),
    Occupation              NATIONAL VARCHAR(100),
    HouseOwnerFlag          NATIONAL CHAR(1),
    NumberCarsOwned         TINYINT,
    AddressLine1            NATIONAL VARCHAR(120),
    AddressLine2            NATIONAL VARCHAR(120),
