...
-- Project :      DATA MODEL
--
-- Date Created : Saturday, September 28, 2019 22:53:16
...
CREATE TABLE AdventureWorksDWBuildVersion(
    DBVersion      NVARCHAR2(50),
    VersionDate    TIMESTAMP(6)
)
;
...
CREATE TABLE NewFactCurrencyRate(
    AverageRate     FLOAT(126),
    CurrencyID      NVARCHAR2(3),
    CurrencyDate    DATE,
    EndOfDayRate    FLOAT(126),
    CurrencyKey     NUMBER(38, 0),
    DateKey         NUMBER(38, 0)
)
;
...
CREATE TABLE ProspectiveBuyer(
    ProspectiveBuyerKey     NUMBER(38, 0)     NOT NULL,
    ProspectAlternateKey    NVARCHAR2(15),
    FirstName               NVARCHAR2(50),
    MiddleName              NVARCHAR2(50),
    LastName                NVARCHAR2(50),
